...
OS_START
	...
	LEA R0, OS_VER_MSG 	; print version message
	PUTS
...
TRAP_HALT	
	LEA R0, HALT_TRAP_MSG 	; display message
	PUTS
	LDI R0,OS_MCR		
	...
	STI R0,OS_MCR		; halt!
TRAP_HALT_SPIN
	BRnzp TRAP_HALT_SPIN	; die here
HALT_TRAP_MSG .STRINGZ "\nOS HALTed!\n"

        
;;; BAD_TRAP - code to execute for undefined trap
BAD_TRAP
	ST  R0, BAD_TRAP_R0 	; context save
	ST  R7, BAD_TRAP_R7
	LEA R0, BAD_TRAP_MSG 	; display message
	PUTS
	LD  R7, BAD_TRAP_R7 	; context restore
	LD  R0, BAD_TRAP_R0 
	RET
BAD_TRAP_R0 .BLKW #1
BAD_TRAP_R7 .BLKW #1
